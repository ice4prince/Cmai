...
class Path:
    ...
    scripts: Annotated[str, "Scripts folder."] = "/project/DPDS/Wang_lab/shared/BCR_antigen/code/DeLAnO"

    rf: Annotated[str, "RosettaFold folder."] = "rfscripts/RoseTTAFold"

    out: Annotated[str, "Output folder."] = "/project/DPDS/Wang_lab/shared/BCR_antigen/code/DeLAnO/example/outputs"
...
class Conf:
    ...
    fasta: Annotated[str, "Input fasta files."] = "/project/DPDS/Wang_lab/shared/BCR_antigen/code/DeLAnO/example/input.fa"
