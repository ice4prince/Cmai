...
parser.add_argument('--fasta',type = str, help = 'The fasta file entering runEbed. When no sequence included in the input, the seperate fasta file of antigens is required',default =None)
